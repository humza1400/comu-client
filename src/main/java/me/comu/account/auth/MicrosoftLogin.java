...
public class MicrosoftLogin {
    ...
    public static Session completeMinecraftLogin(String accessToken) throws Exception {
        ...
        UUID uuid = formatUUID(profile.get("id").getAsString());
    ...
    public static void LoginToMicrosoftAccount(Account account) {
        new Thread(() -> {
            try {
                ...
                e.printStackTrace();
                Logger.getLogger().print("Microsoft re-login failed:\n" + e.getMessage(), Logger.LogType.ERROR);
            }
        }).start();
    }
    ...
    public static String extractFragmentValue(String url, String key) throws Exception {
