...
public class ChatSpammer extends ToggleableModule {

    private final NumberProperty<Long> delay = new NumberProperty<Long>("Delay", List.of("d", "wait"), 3000L, 1000L, 10000L, 1000L);
    private final InputProperty message = new InputProperty("Messages", List.of("message","msg", "m"), "");
    private final BooleanProperty obfuscated = new BooleanProperty("Obfuscated", List.of("obfuscate", "obf", "o"), false);

    private final Stopwatch stopwatch = new Stopwatch();
    private final String[] phraseList = new String[]{"comu client best client", "boonk gang", "WTF he has bhop ka antiknockback and mroe", "whole lotta gang shit", "u gay nerd", "you man thot", "i dont really care waht you say", "bend over and spell run"
            ...
            "U scummed me D:", "i am bisexual whats ur problem with that?", "cant touch this na na na", "i have nothing to do besides play minecraft", "how much for an client sub", "client client op!", "but does it bypass?", "is the json ratted?", "Gas the jews", "you pay for those cheats lol?", "LOL!", "BUT BABE!", "its only toxic if its not true", "send json or scam",
            ...
            , "id rather scissor with a girl then shove a dick up my pussy", "70 bro", "my texture pack turned off", "i can easily convert this UUID f4e5e8ff-a7a8-48e9-be42-783fe5273414 to an IP", "fly reach killaura and more", "dad?", "blitz speaks like a spic", "aris said my virtue skid is the only good skid - blitz",
            "nebula more like suck a dick-ula", "super hax", "gotta love kill aura and fly", "its really ez to tell when ppl r cheating in this game", "he use killaura + bh + anti knockback i saw him im sure", "drop a pin bro", "sniff my ass", "snorkle this fine ass", "drop a pin bitch", "blitz does drive bys with bananas", "my dog queefed in my ass", "my dog queefed in my ass please help", "what are you fat or something", "i fucked my dog", "not if i fuck you first", "im a phat retart", "the password to this minecraft account is  gayman123", "hey guys blitzthunder here",
            ...
            "sorry didnt mean to flex on you with my minecraft bypass", "hard on thots movement", "my discord is private as fuck it's got nuclear launch codes", "u used bhop im not going to fight u wth that dumbass", "stfu bitch", "lets see how good you are", "lets see how good you are", "we gon' $ave d@t m0ney", "GRINGO GOT YO ASS", "ok fat fuck", "gf", "keep talking that shit and i'll forceop my self with a sign",
            ...
            "hye little man i stole ur mom and put my d0ng in her hole", "was it a dream or was it real?", "hmu when your gay", "hi sisters", "stop! u cant win hes huzuni!", "im getting u banned for death threats", "iron man dies in end game trying to kill thanos", "staff tp me now hacks", "guys if you get owner tag do you become owenr?????? hello anyone please", "OMG", "STFU", "stop spamming", "tomato client haxers r gods", "client has best dora da explorers", "huzuni is using a hax cloient with ora",
            "im gonna phase ur base BRUH", "fuck my shleemies!", "you look like a burn victim i wish the fire had finished the job", "1v1 me kiddo b4 i dong u", "add me on skype... oh wait who tf uses that shit anymore", "add me on discord", "apoblo clarinet = bleach", "im so fancy you already know im in the fast lane from LA to TOKYO",
            ...
            "are these your cs binds?", "if youre hacking, that means youre a noob.", "nikko was here", "dox ddos and swatted", "ddox", "make yo move boi", "zeroday b5 is out folks, it's kind of the best hacked client", "our anticheat is our staff team", "my router started talking japanese",
            ...
            "gringo is a fanboy of everything", "U mother has mustache", "wanna hear a joke? lucids autopot", "toggle is 1", "ur kinda cringy", "wtf is watchdog", "spooky isnt spooky", "youre off the dumb juice", "i dont argue over facts", "give my acc back", "you accept dominos pizza cards?", "beg your mom for a job at mcdonalds",
            ...
            "wanna savour it", "why am i on forge?! i dont play legit!", "hey i love minecraft and i hacve nothing better to do so better back off mate", "im making a fourm post on you right now", "im recording this with my own two eyes", "im driving a honda civic right now", "guise if ur gonna hake pick clintz dat r g00d!11!@!@!@!", "L roasted", "shitty was here", "das fax no cap", "im putting a warrant for your arrest", "TEA", "SKSKSKSK", "sksksksk", "trol trying to speak english gives me cancer", "congrats now you get a 5 hour blowjob", "columbine happened because of you", "nice client", "nobody likes u", "lulzsec", "lulz", "imagine doing the math for trajectories", "if you're reading this it's too late", "i read the minecraft handbook dont johnny test me bro", "do you get vote keys from voting????", "rat.exe", "stop removing watermarks or ill activate my rat",
            "join or ban", "fight me bitch", "look how he runs", "i got one shotted i dont know fucking how", "like my killaura is just going to do all the work", "like my aura is just going to do all the work", "comu now has control of your pc", "no hacks at all", "nodus is the best client", "notch is a sellout", "promchacks is the most pro hacker of all time", "recording hackers while hacking yourself", "you slick motherfukker", "w0w hacker abuse", "faithful blacklisted spooky for ddos threats", "vagitanus aura", "i just wanna hear you say i love minecraft", "dark wasnt born, he was skidded", "how do you mine??", "its not killaura if im clicking too", "it wasnt bhop retard it was spacebar", "due to the internal error in the java script called syntax error", "if you guys did enjoy the mc phasing montage dont forget to SMASH that like button!", "imagine if sperm was a different color than red",
            "aye shoutout my boy friendly hes a god", "friendly is a god at the trombone on momz", "crazy how drake washed kendrick", "drake>>", "toufh is a goat", "modz said he found a full ac disabler you just gotta run 4 miles, restart your pc, and blindfold yourself first", "riley hit a wheelie for us", "hairy said he'd be on Friday... it's been 4 years", "abcdefghijklmnopqrstuvwyxz", "how much wood can a woodchuck chuck if a woodchuck could chuck wood", "stop being mean or i will knock u off a block from max build height in mencraft", "Add me on discord cuz i have no friends", "your the type of person to bhop on a client with yport in it",
            "oh shit the command block overheated", "why isnt my autopot working", "A3Eg7rkJDyNqV2hTJftS3VavDdEKCYHNqiV2zSdfXGB5ED0D3Fv8Pi8tBLJAIFMYYo4m2WivbFXMK7lZiH3AcnjofeCcIs6VvJ3P", "yhsyyyy", "send client yayyyy", "RIP FRUIT WRLD", "nooooooo why did he have to die", "i killed juice world dude i didnt mean to", "nooooo the Fercs got juice wrld", "add me on discord GrapeFruit#9190 I MISS fruit wrld", "add me on discord swag#3231 I MISS fruit wrld"
            , "RIP Mac Filler and Fruit Wrld the feds got them", "BUT i HATE MAc FRILLER", "i miss xxxtennismouth he pitchforked me", "hopefully he is pitchforking fru" +
            "it wrld in the afterlife", "super hax","this shelacking is in tribute to juice wrld RIP", "jigga i mother trucking hate juice wrld", "yooo x and juice were taggots and deserved to die RIP MAC THRILLER", "im glad mac thriller died he was a menace to society RIP"};

    private final String[] obfList = new String[]{"grfigferw23ioegrwiobuefgwiowfegiobnwefgino[gweior[biougrwqghfi90w0h9fgt432t0934bgvriowgbr jbhjnv8i3h",
    ...
    public ChatSpammer() {
        super("Chat Spammer", List.of("chatspammer","chatspam", "spammer"), Category.MISCELLANEOUS, "Spams chat with prebuilt messages or your own custom messages (comma seperated)");
        offerProperties(delay, message, obfuscated);
        listeners.add(new Listener<>(TickEvent.class) {
            ...
            public void call(TickEvent event) {
                ...
                if (message.isEmpty()) {
                    if (obfuscated.getValue()) {
                        int idx = ThreadLocalRandom.current().nextInt(obfList.length);
                        toSend = obfList[idx];
                    } else {
                        int idx = ThreadLocalRandom.current().nextInt(phraseList.length);
                        toSend = phraseList[idx];
                    }
                } else {
                    String[] parts = input.split(",");
                    int idx = ThreadLocalRandom.current().nextInt(parts.length);
                    toSend = parts[idx].trim();
                }
